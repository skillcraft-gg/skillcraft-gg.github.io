             ...
             <div className="detail-summary-column">
              ...
              <div className="detail-action-row">
                <div className="skill-install-card">
                  ...
                  <p className="caption">Skillcraft works with your favourite AI coding agents like OpenCode and OpenAI Codex to turn git commits from real projects into verifiable evidence.</p>
